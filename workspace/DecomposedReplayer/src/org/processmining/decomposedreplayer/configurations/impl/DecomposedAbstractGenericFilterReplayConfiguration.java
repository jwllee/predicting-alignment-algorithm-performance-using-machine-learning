...
public abstract class DecomposedAbstractGenericFilterReplayConfiguration extends DecomposedAbstractReplayConfiguration {
	...
	public PNRepResult apply(PluginContext context, XLog log, AcceptingPetriNet net,
		...
		if (clusters == null) {
			...
			msecs = -System.currentTimeMillis();
			nets = getNets(context, net, clusters, parameters, getStrategy());
