...
public class TestAcceptingPetriNetDecompositionFactoryImpl {
	...
	@Test
	public void testMakeDecompositionWithoutParentChildMaps() {
		String netName = "net0";
		...
		AcceptingPetriNetDecomposition decomposition = factory.makeDecomposition(apn, subnetArray);
		
		assertEquals(parentChildMaps, decomposition.getParentChildMaps());
	}

	@Test
	public void testMakeDecompositionWithoutParentChildMapsWithElementsWithDuplicatedLabels() {
		String netName = "net0";
		Petrinet net = PetrinetFactory.newPetrinet(netName);
		AcceptingPetriNet apn = AcceptingPetriNetFactory.createAcceptingPetriNet(net);
